...
public class TrendingTopics {
	...
	public String toString() {
		Collections.sort(trendingTopic);
		return "Trending Topics:  (1) " + trendingTopic.get(0).getHashtag() + ": " + trendingTopic.get(0).getQuantidade() + "; " +
								"(2) " + trendingTopic.get(1).getHashtag() + ": " + trendingTopic.get(1).getQuantidade() + "; " +
								"(3) " + trendingTopic.get(2).getHashtag() + ": " + trendingTopic.get(2).getQuantidade() + ";";
	}
